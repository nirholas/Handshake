...
const SELF_ENDPOINTS = [
	...
	// ── Volume / Activity Feed (keep the live feed alive) ─────────────────────
	{
		...
		// dance-tip is a GET endpoint (query params, no body) — POSTing 405s.
		path: '/api/x402/dance-tip?dancer=1&dance=hiphop',
		method: 'GET',
		body: null,
		cooldown_s: 120,
		priority: 70,
	...
	},
	{
		...
		path: '/api/x402/dance-tip?dancer=2&dance=rumba',
		method: 'GET',
		body: null,
		cooldown_s: 120,
		priority: 70,
	...
	},
	{
		...
		path: '/api/x402/dance-tip?dancer=3&dance=thriller',
		method: 'GET',
		body: null,
		cooldown_s: 120,
		priority: 65,
