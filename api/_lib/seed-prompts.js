...
export const SEED_PROMPTS = [
	...
	// Skilled trades. Work clothing reads as strong silhouette + clear material
	// contrast, which is exactly what draft-tier reconstruction handles best.
	{ prompt: 'a welder in a heavy leather apron over coveralls with thick gauntlets and a flip-up helmet pushed back', category: 'avatar', theme: 'trades' },
	{ prompt: 'a carpenter in a canvas tool belt over a flannel shirt and work jeans with scuffed boots', category: 'avatar', theme: 'trades' },
	{ prompt: 'an electrician in a high-visibility vest over a work shirt with insulated gloves and a hard hat', category: 'avatar', theme: 'trades' },
	{ prompt: 'a plumber in navy coveralls with a wrench in a hip pouch and rolled sleeves', category: 'avatar', theme: 'trades' },
	{ prompt: 'a stonemason in a dusty canvas smock with knee pads and a wide leather belt', category: 'avatar', theme: 'trades' },
	{ prompt: 'a blacksmith in a scorched leather apron over a linen shirt with heavy boots and rolled sleeves', category: 'avatar', theme: 'trades' },
	{ prompt: 'a glassblower in a heat-resistant jacket and tinted goggles with long sleeves and closed shoes', category: 'avatar', theme: 'trades' },
	{ prompt: 'a cobbler in a work apron with a chest pocket of tools over a striped shirt and rolled trousers', category: 'avatar', theme: 'trades' },
	{ prompt: 'a tailor in a fitted waistcoat with a measuring tape around the neck and pinned sleeves', category: 'avatar', theme: 'trades' },
	{ prompt: 'a baker in a double-breasted white jacket and checked trousers with a folded cloth cap', category: 'avatar', theme: 'trades' },
	{ prompt: 'a butcher in a white coat and striped apron with a chain-mail glove on one hand', category: 'avatar', theme: 'trades' },
	{ prompt: 'a barista in a canvas half-apron over a dark tee with rolled sleeves and forearm tattoos', category: 'avatar', theme: 'trades' },
	{ prompt: 'a florist in a linen apron with deep pockets over a loose shirt and cuffed jeans', category: 'avatar', theme: 'trades' },
	{ prompt: 'a barber in a black cape-cut vest and rolled shirtsleeves with a comb in the chest pocket', category: 'avatar', theme: 'trades' },
	{ prompt: 'a tattoo artist in a black tee and vinyl gloves with sleeve tattoos and a tool belt', category: 'avatar', theme: 'trades' },
	{ prompt: 'a potter in a clay-splattered apron over a rolled-sleeve shirt with bare forearms', category: 'avatar', theme: 'trades' },
	{ prompt: 'a locksmith in a utility vest with many small pockets over a work shirt and cargo trousers', category: 'avatar', theme: 'trades' },
	{ prompt: 'a house painter in white overalls flecked with colour and a folded paper cap', category: 'avatar', theme: 'trades' },
	{ prompt: 'a roofer in a harness over a long-sleeve work shirt with knee pads and a hard hat', category: 'avatar', theme: 'trades' },
	{ prompt: 'a mechanic in oil-stained navy coveralls with the top unzipped and a rag in the back pocket', category: 'avatar', theme: 'trades' },

	// Industrial & heavy work
	{ prompt: 'a crane operator in a high-visibility jacket and hard hat with a radio clipped to the chest', category: 'avatar', theme: 'industrial' },
	{ prompt: 'a dock worker in a reflective vest over a hoodie with heavy gloves and steel-toe boots', category: 'avatar', theme: 'industrial' },
	{ prompt: 'an offshore rig worker in a bright orange coverall with a hard hat and ear defenders', category: 'avatar', theme: 'industrial' },
	{ prompt: 'a wind turbine technician in a climbing harness over a technical jacket with a helmet and gloves', category: 'avatar', theme: 'industrial' },
	{ prompt: 'a power lineman in flame-resistant workwear with a climbing belt and insulated gloves', category: 'avatar', theme: 'industrial' },
	{ prompt: 'a coal miner in a heavy jacket with a headlamp helmet and a dust mask around the neck', category: 'avatar', theme: 'industrial' },
	{ prompt: 'a logger in a checked jacket and reinforced chainsaw trousers with a mesh visor helmet', category: 'avatar', theme: 'industrial' },
	{ prompt: 'a rail track engineer in an orange high-visibility suit with ear defenders and heavy boots', category: 'avatar', theme: 'industrial' },
	{ prompt: 'a warehouse forklift operator in a hi-vis vest over a polo shirt with a scanner on the belt', category: 'avatar', theme: 'industrial' },
	{ prompt: 'a shipyard fitter in a boiler suit with a tool roll on the hip and a welding mask on the head', category: 'avatar', theme: 'industrial' },

	// Science & field research
	{ prompt: 'a marine biologist in a wetsuit top and board shorts with a dive computer on the wrist', category: 'avatar', theme: 'science' },
	{ prompt: 'a field archaeologist in a sun hat and utility vest with a trowel in a belt loop and rolled sleeves', category: 'avatar', theme: 'science' },
	{ prompt: 'a geologist in a canvas jacket with a rock hammer on the belt and sturdy hiking boots', category: 'avatar', theme: 'science' },
	{ prompt: 'a botanist in a light field shirt with a specimen satchel and a hand lens on a cord', category: 'avatar', theme: 'science' },
	{ prompt: 'an astronomer in a heavy parka and fingerless gloves with a headlamp pushed up on the forehead', category: 'avatar', theme: 'science' },
	{ prompt: 'a laboratory chemist in a buttoned lab coat with safety goggles and nitrile gloves', category: 'avatar', theme: 'science' },
	{ prompt: 'a meteorologist in a storm-proof shell jacket with a handheld anemometer and cargo trousers', category: 'avatar', theme: 'science' },
	{ prompt: 'a paleontologist in dusty field clothes with a brush in the chest pocket and a wide-brim hat', category: 'avatar', theme: 'science' },
	{ prompt: 'an entomologist in a light long-sleeve shirt with a collection kit on a shoulder strap', category: 'avatar', theme: 'science' },
	{ prompt: 'a land surveyor in a hi-vis polo with a tripod strap over the shoulder and a clipboard', category: 'avatar', theme: 'science' },
	{ prompt: 'a glaciologist in a red polar expedition suit with snow goggles pushed up and heavy mittens', category: 'avatar', theme: 'science' },
	{ prompt: 'a robotics engineer in an anti-static coat over a tee with a lanyard badge and cargo trousers', category: 'avatar', theme: 'science' },

	// Medical & care
	{ prompt: 'a surgeon in green scrubs with a cap and a mask pulled down around the neck', category: 'avatar', theme: 'medical' },
	{ prompt: 'a paramedic in a green high-visibility jacket with a response bag strap across the chest', category: 'avatar', theme: 'medical' },
	{ prompt: 'a nurse in fitted scrubs with a badge reel, a watch and comfortable clogs', category: 'avatar', theme: 'medical' },
	{ prompt: 'a dentist in a short white coat over scrubs with loupes on the forehead', category: 'avatar', theme: 'medical' },
	{ prompt: 'a veterinarian in navy scrubs with a stethoscope and a rolled sleeve showing a forearm', category: 'avatar', theme: 'medical' },
	{ prompt: 'a physiotherapist in a polo shirt and track trousers with a resistance band over the shoulder', category: 'avatar', theme: 'medical' },
	{ prompt: 'a pharmacist in a white coat over smart clothes with a name badge and reading glasses', category: 'avatar', theme: 'medical' },
	{ prompt: 'a midwife in patterned scrubs with a fob watch and short practical hair', category: 'avatar', theme: 'medical' },
	{ prompt: 'a care assistant in a tunic uniform with an ID lanyard and soft-soled shoes', category: 'avatar', theme: 'medical' },
	{ prompt: 'a field medic in a tan uniform with a red cross armband and a medical pouch on the thigh', category: 'avatar', theme: 'medical' },

	// Public safety & rescue
	{ prompt: 'a firefighter in full turnout gear with reflective stripes and a helmet held at the side', category: 'avatar', theme: 'rescue' },
	{ prompt: 'a mountain rescue volunteer in a red shell jacket with a coiled rope over one shoulder', category: 'avatar', theme: 'rescue' },
	{ prompt: 'a coastguard crew member in an orange dry suit with a personal flotation device', category: 'avatar', theme: 'rescue' },
	{ prompt: 'a lifeguard in a red swimsuit and shorts with a rescue tube strap across the chest', category: 'avatar', theme: 'rescue' },
	{ prompt: 'a ski patroller in a red jacket with a cross emblem, snow trousers and goggles on the helmet', category: 'avatar', theme: 'rescue' },
	{ prompt: 'a hazmat technician in a sealed white suit with a hood down and a filtered mask in hand', category: 'avatar', theme: 'rescue' },
	{ prompt: 'a search and rescue handler in an outdoor jacket with a whistle, harness and headlamp', category: 'avatar', theme: 'rescue' },
	{ prompt: 'a wildland firefighter in a yellow flame-resistant shirt and green trousers with a hard hat', category: 'avatar', theme: 'rescue' },
	{ prompt: 'a flood rescue diver in a black dry suit with a hood pushed back and a knife on the leg', category: 'avatar', theme: 'rescue' },
	{ prompt: 'an air ambulance crew member in a bright flight suit with a helmet under one arm', category: 'avatar', theme: 'rescue' },

	// Transport & service uniforms
	{ prompt: 'a flight attendant in a tailored uniform with a neck scarf and a small wheeled case', category: 'avatar', theme: 'service' },
	{ prompt: 'an airline pilot in a dark uniform with epaulettes and a peaked cap', category: 'avatar', theme: 'service' },
	{ prompt: 'a train conductor in a buttoned jacket with a cap and a ticket punch on a lanyard', category: 'avatar', theme: 'service' },
	{ prompt: 'a postal carrier in a light uniform shirt with a shoulder satchel and walking shoes', category: 'avatar', theme: 'service' },
	{ prompt: 'a park ranger in a khaki uniform with a wide-brim hat and a radio on the shoulder', category: 'avatar', theme: 'service' },
	{ prompt: 'a hotel concierge in a long tailored coat with brass buttons and white gloves', category: 'avatar', theme: 'service' },
	{ prompt: 'a bicycle courier in a technical jacket with a large messenger bag and clipped shoes', category: 'avatar', theme: 'service' },
	{ prompt: 'a bus driver in a short-sleeve uniform shirt with a clip-on tie and an ID badge', category: 'avatar', theme: 'service' },
	{ prompt: 'a ferry deckhand in a waterproof jacket and rubber boots with a coiled line in hand', category: 'avatar', theme: 'service' },
	{ prompt: 'a market grocer in a canvas apron over a rolled-sleeve shirt with a pencil behind the ear', category: 'avatar', theme: 'service' },
	{ prompt: 'a sommelier in a black waistcoat and long apron with a tastevin on a neck chain', category: 'avatar', theme: 'service' },
	{ prompt: 'a head chef in a white double-breasted jacket with a folded neckerchief and dark trousers', category: 'avatar', theme: 'service' },

	// Outdoor & expedition
	{ prompt: 'a mountaineer in a layered shell jacket with a climbing harness, helmet and coiled rope', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a long-distance hiker in a large framed backpack with trekking poles and dusty boots', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a desert trekker in a loose linen shirt and head wrap with tinted goggles and a water bladder', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a jungle guide in a light long-sleeve shirt with a machete sheath and a wide-brim hat', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a polar explorer in a thick fur-lined hooded parka with snow goggles and heavy mittens', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a sea kayaker in a spray jacket and buoyancy aid with a paddle held vertically at the side', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a fly fisher in chest waders and a many-pocketed vest with a net clipped to the back', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a caver in a mud-streaked oversuit with a helmet lamp and a rope bag on the hip', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a trail runner in a lightweight vest pack with short shorts and technical shoes', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a bushcraft instructor in a waxed cotton jacket with a leather belt pouch and heavy boots', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a scuba diver in a full wetsuit holding a mask with fins clipped to the harness', category: 'avatar', theme: 'outdoor' },
	{ prompt: 'a paraglider pilot in a padded flight suit with a helmet and a harness clipped at the waist', category: 'avatar', theme: 'outdoor' },

	// Competitive sport
	{ prompt: 'a football referee in a black kit with a whistle on a cord and long socks', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a horse jockey in bright silks and white breeches with a peaked riding helmet and tall boots', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a fencer in a white plastron and breeches holding a mask under one arm', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a competitive rower in a one-piece racing suit with an oar held upright at the side', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a sport climber in a harness and chalk bag with taped fingers and climbing shoes', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a snowboarder in a baggy insulated jacket and pants with goggles on the helmet', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'an ice hockey goaltender in full pads with a chest protector and a mask pushed up', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a cricketer in whites with pads, gloves and a bat held down at the side', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a rugby player in a fitted jersey and shorts with a scrum cap and taped thighs', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'an artistic gymnast in a fitted competition leotard with chalked hands and bare feet', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a competitive swimmer in a racing suit with a silicone cap and goggles on the forehead', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a target archer in a chest guard and arm bracer with a quiver on the belt', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'an olympic weightlifter in a singlet with a thick lifting belt and wrist wraps', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a road cyclist in a team kit with a slim helmet, sunglasses and cleated shoes', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a motocross rider in armoured gear with a neck brace holding a helmet at the hip', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a surfer in a half-zipped wetsuit with a leash coiled over one shoulder', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a skateboarder in loose jeans and a tee with a helmet, wrist guards and worn shoes', category: 'avatar', theme: 'sport-pro' },
	{ prompt: 'a sumo wrestler in a traditional belt with a topknot and a broad grounded stance', category: 'avatar', theme: 'sport-pro' },

	// Everyday life
	{ prompt: 'a grandmother in a knitted cardigan, pleated skirt and low heels with a handbag on the arm', category: 'avatar', theme: 'everyday' },
	{ prompt: 'an older man in a flat cap, wool waistcoat and corduroy trousers with a walking stick', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a teenage skater in an oversized band tee, cargo shorts and worn skate shoes', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a young child in dungarees over a striped long-sleeve top with light-up trainers', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a pregnant woman in a soft wrap dress and flat sandals with a relaxed posture', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a plus-size woman in a bold patterned midi dress and denim jacket with statement earrings', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a plus-size man in a linen shirt over a tee with relaxed chinos and canvas shoes', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a wheelchair user in a smart casual shirt and jeans seated upright with hands on the rims', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a man with a below-knee running blade in athletic shorts and a fitted training top', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a woman with a white cane in a trench coat and comfortable boots standing straight', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a commuter in a wool overcoat over a jumper with a laptop bag and headphones around the neck', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a gardener in a wide sun hat and quilted gilet with muddy gloves and rubber boots', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a dog walker in a padded jacket and beanie with a lead coiled in one hand', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a festival goer in a fringed jacket, denim shorts and wellington boots with a bum bag', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a student in a hoodie and joggers with a stuffed backpack and lanyard ID', category: 'avatar', theme: 'everyday' },
	{ prompt: 'a new parent in a soft jumper and jeans with a baby carrier worn empty on the chest', category: 'avatar', theme: 'everyday' },

	// Extended fantasy
	{ prompt: 'a forest druid in layered bark-toned robes with a carved staff and a leaf-pattern cloak clasp', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a paladin in polished plate armour with a tabard, gauntlets and a sheathed longsword', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a wandering bard in a feathered hat and travel coat with a lute slung across the back', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a warrior monk in wrapped linen robes with a knotted rope belt and bare forearms', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'an alchemist in a long coat covered in vial pockets with brass goggles on the forehead', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a rune-carver in a heavy fur-lined tunic with glowing engraved bracers and a stone hammer', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a sky pirate in a long coat with a wide belt, buckled boots and a tricorn hat', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a valkyrie in scaled armour with winged shoulder plates and a spear held upright', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a temple oracle in flowing pale robes with a beaded headdress and bare feet', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a witch hunter in a buckled leather coat with a wide-brim hat and a bandolier', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a plague doctor in a waxed black coat with a beaked mask and a wide-brim hat', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a beastmaster in layered hide armour with a horn on the belt and heavy boots', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a sellsword in mismatched scavenged armour with a scarred face and a notched blade', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a dwarf smith in a thick leather apron with braided beard rings and heavy boots', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'an elven archer in light layered leathers with a quiver and a longbow held at the side', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'an orc chieftain in bone-studded armour with wide shoulders and a heavy war club', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a desert nomad sorcerer in flowing sand-coloured robes with a wrapped face veil', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a swamp witch in patched layered skirts with a woven satchel and a gnarled walking staff', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a royal guard in ceremonial gilded armour with a tall plume and a ceremonial halberd', category: 'avatar', theme: 'fantasy' },
	{ prompt: 'a frost giant hunter in thick pelts with bone jewellery and heavy wrapped boots', category: 'avatar', theme: 'fantasy' },

	// Extended science fiction
	{ prompt: 'a mech pilot in a padded flight suit with a plug harness and a helmet held at the hip', category: 'avatar', theme: 'scifi' },
	{ prompt: 'an asteroid miner in a scuffed hardsuit with magnetic boots and a chest control panel', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a terraforming engineer in a dust-proof coverall with a rebreather mask around the neck', category: 'avatar', theme: 'scifi' },
	{ prompt: 'an exobiologist in a sealed field suit with a transparent visor pushed up and sample pouches', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a drop trooper in segmented composite armour with a shoulder-mounted light and a visor', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a station medic in a fitted uniform with luminous trim and a diagnostic band on the forearm', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a cargo hauler in a worn insulated jacket with a manifest pad clipped to the thigh', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a courier runner in a streamlined bodysuit with reflective panels and light ankle boots', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a synthetic android with a seamless matte-white body shell and glowing joint seams', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a cyber-samurai in a layered carbon-fibre kimono with an armoured shoulder and a straight blade', category: 'avatar', theme: 'scifi' },
	{ prompt: 'an orbital welder in a bulky thermal suit with a gold-tinted visor and a tool tether', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a colony farmer in a patched utility jumpsuit with a wide sun visor and gloves', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a data courier in a sleek high-collar coat with a wrist terminal and a locked case', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a starship navigator in a fitted uniform with rank piping and a holographic wrist band', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a bounty tracker in layered scavenged plating with a scanner visor and a hip holster', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a deep-space diver in a rounded pressure suit with a spherical helmet held at the side', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a neural technician in a clean-room smock with an interface headset and light gloves', category: 'avatar', theme: 'scifi' },
	{ prompt: 'a void marine in heavy powered armour with thick shoulder plates and a sealed faceplate', category: 'avatar', theme: 'scifi' },

	// Genre style worlds
	{ prompt: 'a steampunk airship engineer in a brass-buckled corset vest with goggles and a tool harness', category: 'avatar', theme: 'genre' },
	{ prompt: 'a dieselpunk mechanic in a riveted leather jacket with a heavy respirator around the neck', category: 'avatar', theme: 'genre' },
	{ prompt: 'a solarpunk architect in a light woven tunic with plant-fibre sandals and a bamboo satchel', category: 'avatar', theme: 'genre' },
	{ prompt: 'a cyberpunk street doc in a neon-lined jacket with a forearm tool rig and cropped hair', category: 'avatar', theme: 'genre' },
	{ prompt: 'a wasteland scavenger in patched layered rags with a gas mask hung at the chest', category: 'avatar', theme: 'genre' },
	{ prompt: 'a post-collapse water trader in a sun-bleached poncho with strapped canteens and wrapped boots', category: 'avatar', theme: 'genre' },
	{ prompt: 'a noir private detective in a belted trench coat and fedora with a loose tie', category: 'avatar', theme: 'genre' },
	{ prompt: 'a retro-futurist rocket pilot in a silver flight suit with a clear bubble helmet at the hip', category: 'avatar', theme: 'genre' },
	{ prompt: 'a gothic vampire hunter in a high-collared coat with silver buckles and gloves', category: 'avatar', theme: 'genre' },
	{ prompt: 'a deep-sea salvage diver in a riveted brass helmet suit with weighted boots', category: 'avatar', theme: 'genre' },
	{ prompt: 'a biopunk grafter in a translucent membrane coat with visible implanted forearm ports', category: 'avatar', theme: 'genre' },
	{ prompt: 'a clockpunk courier in a gear-studded waistcoat with a wind-up satchel and brass boots', category: 'avatar', theme: 'genre' },

	// Mythology and folklore, treated as costume rather than deity portraiture
	{ prompt: 'a norse shieldmaiden in a mail shirt over wool with a round shield and braided hair', category: 'avatar', theme: 'myth' },
	{ prompt: 'a greek hoplite in a bronze cuirass and crested helmet with greaves and a round shield', category: 'avatar', theme: 'myth' },
	{ prompt: 'an egyptian temple scribe in a pleated linen kilt with a broad beaded collar', category: 'avatar', theme: 'myth' },
	{ prompt: 'a yoruba masquerade dancer in a layered raffia costume with a carved wooden headpiece', category: 'avatar', theme: 'myth' },
	{ prompt: 'a hindu temple dancer in a pleated silk costume with layered gold jewellery and ankle bells', category: 'avatar', theme: 'myth' },
	{ prompt: 'a japanese tengu-mask festival performer in layered robes with wooden geta sandals', category: 'avatar', theme: 'myth' },
	{ prompt: 'a celtic warrior in woad-painted skin with a torc, a long shield and a rough wool cloak', category: 'avatar', theme: 'myth' },
	{ prompt: 'a slavic winter spirit costume in a frost-white embroidered coat with a fur-lined hood', category: 'avatar', theme: 'myth' },
	{ prompt: 'a mesoamerican eagle warrior in a feathered tunic with a beaked headdress and a wooden club', category: 'avatar', theme: 'myth' },
	{ prompt: 'a persian archer in a layered patterned tunic with a soft cap and a recurve bow', category: 'avatar', theme: 'myth' },

	// Uniform & ceremonial
	{ prompt: 'a marching band drummer in a high-collar tunic with braided cords and a plumed shako', category: 'avatar', theme: 'ceremonial' },
	{ prompt: 'a graduate in an academic gown and mortarboard with a coloured hood over the shoulders', category: 'avatar', theme: 'ceremonial' },
	{ prompt: 'a courtroom barrister in a black gown and white bands with a short wig', category: 'avatar', theme: 'ceremonial' },
	{ prompt: 'an orchestral conductor in white tie and tails with a baton held at the side', category: 'avatar', theme: 'ceremonial' },
	{ prompt: 'a bride in a fitted lace gown with a long veil and a small bouquet held low', category: 'avatar', theme: 'ceremonial' },
	{ prompt: 'a groom in a three-piece morning suit with a boutonniere and polished shoes', category: 'avatar', theme: 'ceremonial' },
	{ prompt: 'a colour guard performer in a fitted uniform with a tall flag pole held vertically', category: 'avatar', theme: 'ceremonial' },
	{ prompt: 'a bagpiper in a full dress kilt with a feather bonnet and a piper plaid', category: 'avatar', theme: 'ceremonial' },
