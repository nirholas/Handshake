...
// ── LLM chain: shared tool-calling chain + stream reader ─────────────────────
// providerChain() and streamRound() were born here and now live in
// api/_lib/llm-tool-chain.js so the general agent loop (/api/agent/run) runs
// on the same lanes. providerChain is re-exported unchanged for the anchor
// regression tests and any existing importer.
