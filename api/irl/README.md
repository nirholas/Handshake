...
| `GET /api/irl/analytics` | Site-wide usage rollup (pins placed, nearby reads, shares, drop claims) for [/admin/irl-analytics](../../pages/admin/irl-analytics.html). Ops-gated (admin session or `OPS_SECRET`). [`analytics.js`](./analytics.js) |
