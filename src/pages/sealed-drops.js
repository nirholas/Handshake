...
//
// Mounted (2026-07-11): the create + mine sections live inside
// public/vanity-wallet.html (a "Send a sealed gift" section below the vanity
// grinder — the prefix/suffix/format fields reuse that page's own grinding
// UI), and the claim flow is its own page at pages/drop.html, routed by
// vercel.json's `/drop/:id` → `/drop.html` rewrite (id = 24 lowercase hex
// chars, matching api/vanity/drops.js's id format). Backend
// (api/vanity/drops.js, api/og/sealed-drop.js) predates this and is unchanged.
