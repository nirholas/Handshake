...
const UNPUBLISHED_DOCS = new Map([
	...
	['fomo-verified-x-post', 'internal: ready-to-paste X post drafts; posting is owner-gated'],
	...
	['ibm-skillsbuild-x-post', 'internal: paste-ready X copy for the SkillsBuild badge, drafted for the owner to post'],
	...
	['metaplex-agent-deployer-video-script', 'internal: unposted spoken-script drafts for a marketing video'],
	['metaplex-agent-deployer-x-post', 'internal: unposted X announcement drafts, not a reader-facing doc'],
	...
	['onchain-agent-wallets-x-post', 'internal: unposted X announcement drafts, not a reader-facing doc'],
