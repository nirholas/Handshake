...
- **Corpus:** ${num(g.analyzed)} posts written by @${report.handle}, ${g.firstPostAt?.slice(0, 10)} to ${g.lastPostAt?.slice(0, 10)}. ${num(g.retweetsExcluded)} reposts and quotes of other accounts are archived but excluded from every number below: they carry the original author's engagement, not ours.
