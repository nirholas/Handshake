...
`/workspaces/three.ws`, or say "execute `prompts/roadmap/developer-resources-repos.md`".
It is complete on its own. Also read `prompts/roadmap/00-README.md` and `CLAUDE.md`.
