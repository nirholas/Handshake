...
repo, or name its path. Read `prompts/materialize/00-CONTEXT.md` first; its
...
- [ ] Deliverables committed with explicit paths; this file deleted in the closing commit (`git rm prompts/materialize/01-printability-engine.md`) and PROGRESS.md appended.
