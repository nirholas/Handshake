...
**How to run:** paste this whole file into a fresh Claude Code chat in the three.ws repo, or tell the agent to read `prompts/event/06-photo-mode-share.md`. Read [00-CONTEXT.md](00-CONTEXT.md) first.
