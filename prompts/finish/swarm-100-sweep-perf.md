# Sweep: Performance measured and top issues fixed
...
Measure desktop and mobile Lighthouse scores for /, /create, /forge, /marketplace, /play, /docs, /discover, and /chat against production. Record all scores in the report. Fix the highest-impact issues found (render-blocking assets, unsized media, oversized payloads, missing lazy-loading) until each measured page scores at least 80 performance on desktop or the report documents the specific irreducible cost with numbers.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/finish/swarm-100-sweep-perf.md
