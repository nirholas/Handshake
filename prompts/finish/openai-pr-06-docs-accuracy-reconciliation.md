...
Read [`openai-pr-00-START-HERE.md`](openai-pr-00-START-HERE.md) first. This task cleans up the
...
3. Commit with explicit paths and a subject that describes the diff (house
   ...
   prompt file in that same commit:
       ...
       git rm prompts/finish/openai-pr-06-docs-accuracy-reconciliation.md
