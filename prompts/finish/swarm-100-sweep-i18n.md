...
Run the i18n lint and fix every finding: missing keys, unused keys, malformed interpolations. Where a hardcoded user-facing string should be a key, extract it with the existing i18n tooling.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/finish/swarm-100-sweep-i18n.md
