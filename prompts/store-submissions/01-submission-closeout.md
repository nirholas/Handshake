...
`/workspaces/three.ws`, or say "execute `prompts/store-submissions/01-submission-closeout.md`".
It is complete on its own. Also read [`00-README.md`](00-README.md) (the strategy and the store
