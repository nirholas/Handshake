...
`/workspaces/three.ws`, or say "execute `prompts/backlog/11-agent-index-lag.md`". Read
[00-INDEX.md](00-INDEX.md) and `CLAUDE.md` first.
...
1. Finish 100%. Never end with a question or an unexecuted plan. Delete this file when the
   definition of done is verified and log the outcome in [PROGRESS.md](PROGRESS.md).
