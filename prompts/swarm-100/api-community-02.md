# API audit: api/community batch 02 (3 files)
...
- api/community/world-gate.js
- api/community/worlds.js
- api/community/ws-ticket.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-community-02.md
