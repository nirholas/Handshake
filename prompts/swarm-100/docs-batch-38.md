# Docs audit batch 38: /tutorials/explore-docs-world through /tutorials/view-in-ar
...
3. Probe production for each path:
       ...
       for p in /tutorials/explore-docs-world /tutorials/embed-in-30-seconds /tutorials/customize-appearance /tutorials/swap-avatar-in-studio /tutorials/greeting-and-first-speech /tutorials/share-your-agent /tutorials/selfie-to-avatar /tutorials/view-in-ar; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /tutorials/explore-docs-world ("Tutorial · Explore the docs as a 3D world")
- /tutorials/embed-in-30-seconds ("Tutorial · Embed in 30 seconds")
- /tutorials/customize-appearance ("Tutorial · Customize size, position & background")
- /tutorials/swap-avatar-in-studio ("Tutorial · Pick & swap an avatar in Studio")
- /tutorials/greeting-and-first-speech ("Tutorial · Add a greeting & first speech line")
- /tutorials/share-your-agent ("Tutorial · Share your agent (link, QR, social preview)")
- /tutorials/selfie-to-avatar ("Tutorial · Turn a selfie into a 3D avatar")
- /tutorials/view-in-ar ("Tutorial · View your 3D model in AR")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-38.md
