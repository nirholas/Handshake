# Docs audit batch 22: /docs/character-library through /docs/notifications
...
3. Probe production for each path:
       ...
       for p in /docs/character-library /docs/object-library /docs/minted /docs/reasoning-ledger /docs/timeline /docs/daily-match /docs/agent-symphony /docs/notifications; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/character-library ("Docs: Character Library")
- /docs/object-library ("Docs: Object Library")
- /docs/minted ("Docs: Minted 3D Assets")
- /docs/reasoning-ledger ("Docs: The Reasoning Ledger")
- /docs/timeline ("Docs: The Story So Far")
- /docs/daily-match ("Docs: Daily Match")
- /docs/agent-symphony ("Docs: Agent Symphony")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-22.md
