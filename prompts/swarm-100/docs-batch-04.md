# Docs audit batch 04: /docs/cosmos through /docs/avatar-studio
...
3. Probe production for each path:
       ...
       for p in /docs/cosmos /docs/splat /docs/capture /docs/restyle /docs/scene-studio /docs/compose /docs/animation-studio /docs/avatar-studio; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/cosmos ("Docs · Cosmos (living worlds)")
- /docs/splat ("Docs · Splat viewer (Gaussian avatars)")
- /docs/capture ("Docs · Scene Capture (video to point cloud)")
- /docs/restyle ("Docs · Restyle Studio")
- /docs/scene-studio ("Docs · Scene Studio")
- /docs/compose ("Docs · Scene Composer")
- /docs/animation-studio ("Docs · Animation Studio")
- /docs/avatar-studio ("Docs · Avatar Studio")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-04.md
