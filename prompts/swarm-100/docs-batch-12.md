# Docs audit batch 12: /docs/embedding through /docs/mcp-x402
...
3. Probe production for each path:
       ...
       for p in /docs/embedding /docs/assistant-widget /docs/web-component /docs/mcp /docs/mcp-studio /docs/chatgpt-ar /docs/mcp-scenes /docs/mcp-x402; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done
...
- /docs/assistant-widget ("Docs · Assistant widget")
- /docs/web-component ("Docs · <agent-3d>")
- /docs/mcp ("Docs · MCP")
- /docs/mcp-studio ("Docs · 3D Studio MCP (free)")
- /docs/chatgpt-ar ("Docs · AR in ChatGPT")
- /docs/mcp-scenes ("Docs · Scenes MCP")
- /docs/mcp-x402 ("Docs · x402 Wallet MCP")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-12.md
