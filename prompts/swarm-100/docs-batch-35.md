# Docs audit batch 35: /docs/ibm-x402-mcp through /docs/chatgpt-3d-studio-gpt
...
3. Probe production for each path:
       ...
       for p in /docs/ibm-x402-mcp /docs/aws-builder-center /docs/aws-marketplace /docs/aws-partner-spotlight /docs/aws-builder-center-mcp-agents /docs/aws-builder-center-agent-payment-sessions /docs/aws-builder-center-marketplace-x402 /docs/chatgpt-3d-studio-gpt; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/ibm-x402-mcp ("Docs · IBM Granite pay-per-call MCP")
- /docs/aws-builder-center ("Docs · three.ws on the AWS Builder Center")
- /docs/aws-marketplace ("Docs · three.ws on AWS Marketplace")
- /docs/aws-partner-spotlight ("Docs · three.ws on AWS")
- /docs/aws-builder-center-mcp-agents ("Docs · An MCP server whose tools pay for themselves")
- /docs/aws-builder-center-agent-payment-sessions ("Docs · Give your AI agent a budget, not a private key")
- /docs/aws-builder-center-marketplace-x402 ("Docs · One paywall, two economies")
- /docs/chatgpt-3d-studio-gpt ("Docs · The 3D Studio custom GPT configuration")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-35.md
