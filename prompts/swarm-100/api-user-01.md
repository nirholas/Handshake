# API audit: api/user batch 01 (6 files)
...
- api/user/provider-keys.js
- api/user/wallet/fund-agent.js
- api/user/wallet/history.js
- api/user/wallet/index.js
- api/user/wallet/send.js
- api/user/x402-subscriptions.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-user-01.md
