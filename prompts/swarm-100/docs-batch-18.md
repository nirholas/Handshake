# Docs audit batch 18: /docs/agent-abilities through /tutorials/agent-personality
...
3. Probe production for each path:
       ...
       for p in /docs/agent-abilities /news /changelog /docs/ar /docs/bnb-payments /docs/agent-sniper /docs/sniper-autonomy /tutorials/agent-personality; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/agent-abilities ("Docs · What Agents Can Do: The Complete Dossier")
- /news ("News and Announcements")
- /changelog ("Changelog")
- /docs/ar ("Docs: AR Viewing")
- /docs/bnb-payments ("Docs: BNB Payments")
- /docs/agent-sniper ("Agent Sniper: Autonomous On-Chain Trading")
- /docs/sniper-autonomy ("Earned Autonomy: Freedom the Sniper Fleet Has to Trade For")
- /tutorials/agent-personality ("Tutorial: Agent Personality")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-18.md
