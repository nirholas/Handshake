# Docs audit batch 03: /3d through /docs/diorama
...
3. Probe production for each path:
       ...
       for p in /3d /crypto-api /docs/news-rights /docs/forge /docs/forge-pipeline /docs/how-forge-works /docs/image-to-3d /docs/diorama; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done
...
- /docs/news-rights ("Docs · Publisher rights in the news reader")
- /docs/forge ("Docs · Forge (text & image to 3D)")
- /docs/forge-pipeline ("Docs · The Forge pipeline (architecture deep dive)")
- /docs/how-forge-works ("Docs · How the Forge works, in plain language")
- /docs/image-to-3d ("Docs · Image to 3D")
- /docs/diorama ("Docs · Diorama (text to world)")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-03.md
