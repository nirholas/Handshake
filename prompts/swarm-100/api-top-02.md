# API audit: api/*.js batch 02 (10 files)
...
- api/agent-og.js
- api/agent-reflect-digest.js
- api/agent-screen-active.js
- api/agent-screen-control-drain.js
- api/agent-screen-control.js
- api/agent-screen-push.js
- api/agent-screen-stream.js
- api/agent-share.js
- api/agent-skill-price.js
- api/agent-skills.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-top-02.md
