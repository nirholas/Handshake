# API audit: api/agent batch 02 (5 files)
...
- api/agent/wallet.js
- api/agent/watch-intent.js
- api/agent/watch-status.js
- api/agent/watch-wanted.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-agent-02.md
