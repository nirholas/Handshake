# API audit: api/friends batch 01 (4 files)
...
- api/friends/messages.js
- api/friends/presence-ticket.js
- api/friends/search.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-friends-01.md
