# Docs audit batch 19: /tutorials/sign-with-your-avatar through /docs/nvidia-models
...
3. Probe production for each path:
       ...
       for p in /tutorials/sign-with-your-avatar /tutorials/animate-your-avatar /tutorials/build-a-scene /tutorials/arm-an-agent-sniper /aws /docs/nvidia-inception /docs/3d-asset-pipeline /docs/nvidia-models; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /tutorials/sign-with-your-avatar ("Tutorial: Make Your Avatar Sign (ASL)")
- /tutorials/animate-your-avatar ("Tutorial: Animate Your Avatar")
- /tutorials/build-a-scene ("Tutorial: Build a Scene")
- /tutorials/arm-an-agent-sniper ("Tutorial · Arm an Autonomous Sniper on Your Agent")
- /aws ("three.ws on AWS")
- /docs/nvidia-inception ("Docs · NVIDIA Inception membership")
- /docs/3d-asset-pipeline ("Docs · The 3D asset pipeline (FBX, GLB, and clip JSON)")
- /docs/nvidia-models ("Docs · Every NVIDIA model three.ws runs for free")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-19.md
