# Cron audit batch 13: /api/cron/changelog-push and 7 more
...
2. Scheduler truth (crons run on Cloud Scheduler, never in-process):
       ...
       gcloud scheduler jobs list --project aerial-vehicle-466722-p5 --location us-central1 | grep -E 'changelog-push|commit-feed-push|forge-off-crown|quality-bench|garment-catalog-audit|garment-job-sweep|fact-check-benchmark|gpu-keepwarm'
...
- /api/cron/changelog-push
- /api/cron/commit-feed-push
- /api/cron/forge-off-crown
- /api/cron/quality-bench
- /api/cron/garment-catalog-audit
- /api/cron/garment-job-sweep
- /api/cron/fact-check-benchmark
- /api/cron/gpu-keepwarm
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/cron-batch-13.md
