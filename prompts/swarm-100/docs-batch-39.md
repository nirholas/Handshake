# Docs audit batch 39: /tutorials/import-avatar-url through /tutorials/web-component-end-to-end
...
3. Probe production for each path:
       ...
       for p in /tutorials/import-avatar-url /tutorials/walk-companion /tutorials/sperax-tour /tutorials/first-agent /tutorials/embed-on-website /tutorials/personal-ai-site /tutorials/js-api-events /tutorials/web-component-end-to-end; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /tutorials/import-avatar-url ("Tutorial · Import an avatar by URL")
- /tutorials/walk-companion ("Tutorial · Add the Walk Companion to your site")
- /tutorials/sperax-tour ("Tutorial · Load a ready-made 3D tour for a DeFi protocol (Sperax)")
- /tutorials/first-agent ("Tutorial · Build your first agent (from scratch)")
- /tutorials/embed-on-website ("Tutorial · Embed on a website (HTML, React, Next.js)")
- /tutorials/personal-ai-site ("Tutorial · Build a personal AI website")
- /tutorials/js-api-events ("Tutorial · Drive the agent with the JavaScript API")
- /tutorials/web-component-end-to-end ("Tutorial · Use the <agent-3d> web component end-to-end")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-39.md
