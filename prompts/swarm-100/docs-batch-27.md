# Docs audit batch 27: /docs/animations through /docs/avatar-thumbnails
...
3. Probe production for each path:
       ...
       for p in /docs/animations /docs/choreography /docs/architecture /docs/avatar-creation /docs/avatar-inspector /docs/avatar-pipeline /docs/avatar-reconstruction /docs/avatar-thumbnails; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/animations ("Docs · Animations")
- /docs/choreography ("Docs · Choreography")
- /docs/architecture ("Docs · Architecture overview")
- /docs/avatar-creation ("Docs · Avatar creation")
- /docs/avatar-inspector ("Docs · Avatar inspector")
- /docs/avatar-pipeline ("Docs · The avatar pipeline")
- /docs/avatar-reconstruction ("Docs · Selfie to avatar reconstruction")
- /docs/avatar-thumbnails ("Docs · Avatar thumbnails")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-27.md
