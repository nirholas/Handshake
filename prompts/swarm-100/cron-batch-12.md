# Cron audit batch 12: /api/cron/treasury-sweepback and 7 more
...
2. Scheduler truth (crons run on Cloud Scheduler, never in-process):
       ...
       gcloud scheduler jobs list --project aerial-vehicle-466722-p5 --location us-central1 | grep -E 'treasury-sweepback|free-model-audit|economy-reconcile|x402-ring-leak-scan|wallets-leak-scan|vanity-inventory-replenish|news-archive-append|leaderboard-rollup'
...
- /api/cron/treasury-sweepback
- /api/cron/free-model-audit
- /api/cron/economy-reconcile
- /api/cron/x402-ring-leak-scan
- /api/cron/wallets-leak-scan
- /api/cron/vanity-inventory-replenish
- /api/cron/news-archive-append
- /api/cron/leaderboard-rollup
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/cron-batch-12.md
