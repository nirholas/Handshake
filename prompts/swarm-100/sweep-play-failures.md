# Sweep: Play world failure audit clean
...
Run the audit and fix every finding at root. /play is a flagship surface with live multiplayer; failures here are user-visible immediately.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sweep-play-failures.md
