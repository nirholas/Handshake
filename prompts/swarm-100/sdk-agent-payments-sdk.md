# Module audit: agent-payments-sdk/
...
1. Read agent-payments-sdk/README.md and agent-payments-sdk/package.json (or the equivalent manifest).
2. Find every consumer: grep the repo for imports of this module and check
   STRUCTURE.md for the surfaces it powers.

## Task: bring agent-payments-sdk/ to verified-shippable
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sdk-agent-payments-sdk.md
