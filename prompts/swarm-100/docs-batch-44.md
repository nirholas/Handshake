# Docs audit batch 44: /docs/ghost-copy through /docs/airdrops
...
3. Probe production for each path:
       ...
       for p in /docs/ghost-copy /docs/trader-passport /docs/portfolio /docs/airdrops; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/ghost-copy ("Docs · Ghost-copy")
- /docs/trader-passport ("Docs · Trader Passport")
- /docs/portfolio ("Docs · Wallet Portfolio")
- /docs/airdrops ("Docs · Airdrop Checker")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-44.md
