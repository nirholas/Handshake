# Docs audit batch 28: /docs/avatar-wardrobe through /docs/embody
...
3. Probe production for each path:
       ...
       for p in /docs/avatar-wardrobe /docs/character-studio /docs/concierge /docs/configuration /docs/contributing /docs/deployment /docs/editor /docs/embody; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/avatar-wardrobe ("Docs · The additive wardrobe")
- /docs/character-studio ("Docs · Avatar Studio")
- /docs/concierge ("Docs · Concierge, an AI chat widget with a 3D face")
- /docs/configuration ("Docs · Configuration reference")
- /docs/contributing ("Docs · Contributing to three.ws")
- /docs/deployment ("Docs · Deployment and self-hosting")
- /docs/editor ("Docs · Editor guide")
- /docs/embody ("Docs · Embody, a 3D body in one paid call")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-28.md
