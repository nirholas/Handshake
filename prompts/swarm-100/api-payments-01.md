# API audit: api/payments batch 01 (5 files)
...
- api/payments/_config.js
- api/payments/evm/[action].js
- api/payments/intent.js
- api/payments/purchase-skill.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-payments-01.md
