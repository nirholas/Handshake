# Cron audit batch 03: /api/cron/reconstruct-sweep and 7 more
...
2. Scheduler truth (crons run on Cloud Scheduler, never in-process):
       ...
       gcloud scheduler jobs list --project aerial-vehicle-466722-p5 --location us-central1 | grep -E 'reconstruct-sweep|smart-money-rollup|db-retention|smart-money-graph|radar-watchlist|intel-learn|oracle-score|gmgn-seed'
...
- /api/cron/reconstruct-sweep
- /api/cron/smart-money-rollup
- /api/cron/db-retention
- /api/cron/smart-money-graph
- /api/cron/radar-watchlist
- /api/cron/intel-learn
- /api/cron/oracle-score
- /api/cron/gmgn-seed
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/cron-batch-03.md
