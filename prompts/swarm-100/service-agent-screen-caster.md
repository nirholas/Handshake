# Service audit: services/agent-screen-caster
...
1. Read services/agent-screen-caster/README.md and its run configuration.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/service-agent-screen-caster.md
