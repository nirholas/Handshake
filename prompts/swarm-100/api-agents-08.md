# API audit: api/agents batch 08 (10 files)
...
- api/agents/sns.js
- api/agents/solana-airdrop.js
- api/agents/solana-guard.js
- api/agents/solana-intent.js
- api/agents/solana-trade.js
- api/agents/solana-wallet.js
- api/agents/solana/[action].js
- api/agents/solana/_handlers.js
- api/agents/suggest-spec.js
- api/agents/suggest.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-agents-08.md
