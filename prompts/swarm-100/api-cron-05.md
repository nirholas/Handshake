# API audit: api/cron batch 05 (10 files)
...
- api/cron/oracle-score.js
- api/cron/payment-session-sweep.js
- api/cron/pulse-tick.js
- api/cron/quality-bench.js
- api/cron/quota-check.js
- api/cron/radar-watchlist.js
- api/cron/recompute-reputation.js
- api/cron/reconcile-decisions.js
- api/cron/reconstruct-sweep.js
- api/cron/reflect-sweep.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-cron-05.md
