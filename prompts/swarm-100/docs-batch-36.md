# Docs audit batch 36: /docs/mcp-agent through /docs/docs-world
...
3. Probe production for each path:
       ...
       for p in /docs/mcp-agent /docs/mcp-x402-bazaar /docs/3d-pipeline /docs/PROTOCOL-vanity /docs/changelog /docs/agenc /docs/live-docs /docs/docs-world; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/mcp-agent ("Docs · The three.ws Agent MCP server")
- /docs/mcp-x402-bazaar ("Docs · The x402 Bazaar MCP server")
- /docs/3d-pipeline ("Docs · The 3D asset pipeline, stage by stage")
- /docs/PROTOCOL-vanity ("Docs · The provably-fair vanity grinding protocol")
- /docs/changelog ("Docs · Changelog and versioning")
- /docs/agenc ("Docs · AgenC")
- /docs/live-docs ("Docs · Live Docs")
- /docs/docs-world ("Docs · Docs World")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-36.md
