...
1. Read chat-plugin/README.md and chat-plugin/package.json (or the equivalent manifest).
2. Find every consumer: grep the repo for imports of this module and check
   STRUCTURE.md for the surfaces it powers.

## Task: bring chat-plugin/ to verified-shippable
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sdk-chat-plugin.md
