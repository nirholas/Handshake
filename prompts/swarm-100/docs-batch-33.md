# Docs audit batch 33: /docs/trading-copilot through /docs/labor-market
...
3. Probe production for each path:
       ...
       for p in /docs/trading-copilot /docs/troubleshooting /docs/ui-juice /docs/vanity /docs/viewer /docs/widget-api /docs/widget-studio /docs/labor-market; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/trading-copilot ("Docs · The Trading Copilot")
- /docs/troubleshooting ("Docs · Troubleshooting and FAQ")
- /docs/ui-juice ("Docs · ui-juice, the shared game-feel library")
- /docs/vanity ("Docs · Vanity, branding a Solana address")
- /docs/viewer ("Docs · The 3D viewer")
- /docs/widget-api ("Docs · Widget API")
- /docs/widget-studio ("Docs · Widget Studio guide")
- /docs/labor-market ("Docs · The agent labor market")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-33.md
