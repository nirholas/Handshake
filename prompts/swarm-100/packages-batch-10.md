# Package audit batch 10: threews-avatar-mcp, tool-sdk, tutor-mcp, vanity, vanity-mcp, viewer-presets
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/packages-batch-10.md
