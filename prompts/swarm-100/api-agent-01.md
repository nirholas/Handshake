# API audit: api/agent batch 01 (10 files)
...
- api/agent/activity.js
- api/agent/anchor-script.js
- api/agent/caster-config.js
- api/agent/dreams.js
- api/agent/guard.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-agent-01.md
