...
memory of what used to fail:
    ...
    npm run audit:docs && npm run check:docs-freshness
...
Run both. Fix dead relative links, site links matching no route, commands naming missing scripts, and packages or workers directories missing a README. Freshness failures mean a doc contradicts current code: fix the doc or the code, whichever is wrong.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sweep-docs-audit.md
