# Docs audit batch 31: /docs/onboarding-tier through /docs/risk-acknowledgment
...
3. Probe production for each path:
       ...
       for p in /docs/onboarding-tier /docs/onchain-agents /docs/permissions /docs/persona-hub /docs/procedural-animation /docs/provenance /docs/remix /docs/risk-acknowledgment; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/onboarding-tier ("Docs · The onboarding tier")
- /docs/onchain-agents ("Docs · Deploying agents on-chain in bulk")
- /docs/permissions ("Docs · Permissions and delegation")
- /docs/persona-hub ("Docs · Persona Hub")
- /docs/procedural-animation ("Docs · Procedural animation")
- /docs/provenance ("Docs · Verifiable 3D provenance")
- /docs/remix ("Docs · The remix economy")
- /docs/risk-acknowledgment ("Docs · The real-funds risk acknowledgment")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-31.md
