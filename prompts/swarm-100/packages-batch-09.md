# Package audit batch 09: sign-language, signals-mcp, skill-license, spatial-mcp, strategies, three-token-mcp
...
- packages/sign-language
- packages/signals-mcp
- packages/skill-license
- packages/spatial-mcp
- packages/strategies
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/packages-batch-09.md
