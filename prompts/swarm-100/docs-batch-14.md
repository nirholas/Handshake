# Docs audit batch 14: /docs/sdk through /walkthroughs/find-an-agent-worth-using
...
3. Probe production for each path:
       ...
       for p in /docs/sdk /docs/listings /tutorials /walkthroughs /walkthroughs/forge-your-first-3d-model /walkthroughs/build-your-first-agent /walkthroughs/embed-a-3d-avatar /walkthroughs/find-an-agent-worth-using; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done
...
- /docs/sdk ("Docs · SDK")
- /docs/listings ("Docs · Listings & Distribution")
- /tutorials ("Tutorials")
- /walkthroughs ("Walkthroughs")
- /walkthroughs/forge-your-first-3d-model ("Walkthrough · Forge your first 3D model")
- /walkthroughs/build-your-first-agent ("Walkthrough · Build your first agent")
- /walkthroughs/embed-a-3d-avatar ("Walkthrough · Embed a 3D avatar on your site")
- /walkthroughs/find-an-agent-worth-using ("Walkthrough · Find an agent worth using")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-14.md
