...
memory of what used to fail:
    ...
    npm run audit:tour-atlas && npm run tour:atlas:health
...
Run both. Broken tour stops get fixed at the stop definition or the page it points to. The tour is a first-run surface; a broken stop is a first-impression defect.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sweep-tour-atlas.md
