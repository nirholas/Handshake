# Docs audit batch 06: /docs/genome through /docs/alpha-copilot
...
3. Probe production for each path:
       ...
       for p in /docs/genome /docs/agent-studio /docs/brain /docs/integrations /docs/autopilot /docs/signals /docs/agi /docs/alpha-copilot; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/genome ("Docs · Agent Genome")
- /docs/agent-studio ("Docs · Agent Studio")
- /docs/brain ("Docs · Multi-LLM Brain")
- /docs/integrations ("Docs · Integrations")
- /docs/autopilot ("Docs · Coin Autopilot")
- /docs/signals ("Docs · Signal Marketplace")
- /docs/agi ("Docs · The AGI")
- /docs/alpha-copilot ("Docs · Alpha Co-pilot")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-06.md
