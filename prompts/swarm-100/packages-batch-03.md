# Package audit batch 03: audio-mcp, autopilot-mcp, avatar-agent-mcp, avatar-cli, avatar-schema, billing-mcp
...
- packages/audio-mcp
- packages/autopilot-mcp
- packages/avatar-agent-mcp
- packages/avatar-cli
- packages/avatar-schema
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/packages-batch-03.md
