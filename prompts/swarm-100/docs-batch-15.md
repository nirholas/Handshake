# Docs audit batch 15: /examples through /tutorials/nvidia-3d-free
...
3. Probe production for each path:
       ...
       for p in /examples /tutorials/text-to-3d /tutorials/build-a-3d-asset-pipeline /tutorials/add-a-3d-assistant /tutorials/image-to-3d /tutorials/prompts-for-3d /tutorials/generate-3d-api /tutorials/nvidia-3d-free; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done
...
- /examples ("Examples")
- /tutorials/text-to-3d ("Tutorial · Text Prompt to 3D Model")
- /tutorials/build-a-3d-asset-pipeline ("Tutorial: build a 3D asset pipeline")
- /tutorials/add-a-3d-assistant ("Tutorial · Add a 3D Avatar Assistant")
- /tutorials/image-to-3d ("Tutorial · Photos to 3D Model")
- /tutorials/prompts-for-3d ("Tutorial · Prompt Recipes for 3D Generation")
- /tutorials/generate-3d-api ("Tutorial · Generate 3D Models from Code")
- /tutorials/nvidia-3d-free ("Tutorial · Generate 3D Models Free, Powered by NVIDIA")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-15.md
