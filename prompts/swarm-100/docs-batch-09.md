# Docs audit batch 09: /docs/social-layer through /docs/x402
...
3. Probe production for each path:
       ...
       for p in /docs/social-layer /docs/do-i-need-crypto /docs/quick-start /docs/agent-system /docs/erc8004 /docs/agent-reputation /docs/trust-primitives /docs/x402; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/social-layer ("Docs · The Social Layer")
- /docs/do-i-need-crypto ("Docs · Do I Need Crypto?")
- /docs/quick-start ("Docs · Quick Start")
- /docs/agent-system ("Docs · Agent System")
- /docs/erc8004 ("Docs · ERC-8004")
- /docs/agent-reputation ("Docs · Agent Reputation")
- /docs/trust-primitives ("Docs · Trust Primitives")
- /docs/x402 ("Docs · x402 Protocol")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-09.md
