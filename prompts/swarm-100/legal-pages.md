# Legal pages audit: every route in the legal section
...
3. Probe production for each path:
       ...
       for p in /legal /legal/privacy /legal/eula /legal/tos /legal/risk /legal/content-policy; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/legal-pages.md
