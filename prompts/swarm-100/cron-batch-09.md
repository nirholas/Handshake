# Cron audit batch 09: /api/cron/pumpfun-graduations-sync and 7 more
...
2. Scheduler truth (crons run on Cloud Scheduler, never in-process):
       ...
       gcloud scheduler jobs list --project aerial-vehicle-466722-p5 --location us-central1 | grep -E 'pumpfun-graduations-sync|solana-attest-event-cleanup|settle-royalties|process-subscriptions|run-coin-cycle|run-coin-payouts|club-payouts|siwx-gc'
...
- /api/cron/pumpfun-graduations-sync
- /api/cron/solana-attest-event-cleanup
- /api/cron/settle-royalties
- /api/cron/process-subscriptions
- /api/cron/run-coin-cycle
- /api/cron/run-coin-payouts
- /api/cron/club-payouts
- /api/cron/siwx-gc
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/cron-batch-09.md
