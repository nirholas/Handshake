# Package audit batch 01: activity-mcp, agenc, agenc-mcp, agent-guards, agent-memory, agent-runtime
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/packages-batch-01.md
