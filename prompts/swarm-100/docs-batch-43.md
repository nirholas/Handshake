# Docs audit batch 43: /tutorials/ship-an-avatar-manifest through /tutorials/animate-your-agent
...
3. Probe production for each path:
       ...
       for p in /tutorials/ship-an-avatar-manifest /tutorials/write-a-guard /guards /docs/tutorials/write-a-guard /tutorials/earn-and-spend-in-play /docs/showcase /docs/tutorials/earn-and-spend-in-play /tutorials/animate-your-agent; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /tutorials/ship-an-avatar-manifest ("Tutorial · Ship an avatar manifest")
- /tutorials/write-a-guard ("Tutorial · Write a repository guard")
- /guards ("Repository guards")
- /docs/tutorials/write-a-guard ("Tutorial · Write a repository guard")
- /tutorials/earn-and-spend-in-play ("Tutorial · Earn and spend in /play")
- /docs/showcase ("Docs: The showcase")
- /docs/tutorials/earn-and-spend-in-play ("Docs · Tutorial: earn and spend in /play")
- /tutorials/animate-your-agent ("Tutorial · Give your agent body language")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-43.md
