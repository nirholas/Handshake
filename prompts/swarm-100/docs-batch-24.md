# Docs audit batch 24: /docs/viability through /docs/world-lines
...
3. Probe production for each path:
       ...
       for p in /docs/viability /docs/press-kit /docs/partners /docs/agent-identities /docs/okx-marketplace /docs/avatar-engines /docs/stage /docs/world-lines; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/viability ("Docs: Viability")
- /docs/press-kit ("Docs: Press kit")
- /docs/partners ("Docs: Partner ecosystem")
- /docs/agent-identities ("Docs: Agent Identity Studio")
- /docs/okx-marketplace ("Docs: OKX.AI marketplace services")
- /docs/avatar-engines ("Docs: Avatar Engines Atlas")
- /docs/stage ("Docs: Living Stages")
- /docs/world-lines ("Docs: World Lines")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-24.md
