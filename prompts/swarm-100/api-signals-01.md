# API audit: api/signals batch 01 (6 files)
...
- api/signals/_common.js
- api/signals/feed.js
- api/signals/feeds.js
- api/signals/marketplace.js
- api/signals/stream.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-signals-01.md
