...
3. Probe production for each path:
       ...
       for p in /blog/three-ws-on-aws-marketplace /blog/agent-3d-web-component /blog/2500-new-animations /blog/three-ws-x402-bazaar /blog/real-time-voice-interaction /blog/three-ws-on-alibaba-cloud-marketplace /blog/three-ws-on-bnb-chain-dappbay /blog/three-ws-hackernoon-partnership /blog/three-ws-on-coinmarketcap /blog/how-to-embed-3d-onchain-agents; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of blog pages, then fix everything found

Pages in this batch:

- /blog/three-ws-on-aws-marketplace ("three.ws Launches on AWS Marketplace, Bringing On-Chain 3D AI Agents to Enterprise Procurement")
- /blog/agent-3d-web-component ("We Just Shipped the 3D Layer for the Internet: <agent-3d>")
- /blog/2500-new-animations ("2,500 New 3D Animations Coming to three.ws")
- /blog/three-ws-x402-bazaar ("three.ws Listed on Coinbase x402 Bazaar and agentic.market")
- /blog/real-time-voice-interaction ("Real-Time Voice Interaction with 3D AI Agents: Preview")
- /blog/three-ws-on-alibaba-cloud-marketplace ("three.ws Launches on Alibaba Cloud Marketplace, Bringing Native x402 Agent Payments to Hyperscale")
- /blog/three-ws-on-bnb-chain-dappbay ("three.ws Listed on BNB Chain's Dappbay Directory")
- /blog/three-ws-hackernoon-partnership ("three.ws Teams Up with HackerNoon")
- /blog/three-ws-on-coinmarketcap ("three.ws Is Now Live on CoinMarketCap")
- /blog/how-to-embed-3d-onchain-agents ("How to Embed 3D On-Chain Agents on Your Site")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/blog-batch-03.md
