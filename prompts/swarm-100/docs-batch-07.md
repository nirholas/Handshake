# Docs audit batch 07: /docs/guardian through /docs/fact-check
...
3. Probe production for each path:
       ...
       for p in /docs/guardian /docs/strategy-objects /docs/terminal /docs/smart-money /docs/radar /docs/clash /docs/x402-studio /docs/fact-check; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/guardian ("Docs · Guardian console")
- /docs/strategy-objects ("Docs · Strategy Objects")
- /docs/terminal ("Docs · Mission Control")
- /docs/smart-money ("Docs · Smart Money Radar")
- /docs/radar ("Docs · Coin Radar")
- /docs/clash ("Docs · Coin Clash")
- /docs/x402-studio ("Docs · x402 Studio")
- /docs/fact-check ("Docs · Fact Check")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-07.md
