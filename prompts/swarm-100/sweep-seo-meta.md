# Sweep: SEO meta complete and unique
...
Run the meta audit. Every page in data/pages.json gets a specific title and description; duplicates get rewritten to be page-specific. Verify og and twitter card tags on the ten highest-priority pages render real previews.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sweep-seo-meta.md
