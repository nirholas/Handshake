# Docs audit batch 08: /docs/daily-forge through /docs/sketchfab
...
3. Probe production for each path:
       ...
       for p in /docs/daily-forge /docs/crypto-api /docs/autonomous-economy /docs/walk /docs/start-here /docs/make-your-agent /docs/share-and-embed /docs/sketchfab; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/daily-forge ("Docs · Daily Forge")
- /docs/crypto-api ("Docs · Crypto Data API")
- /docs/autonomous-economy ("Docs · The autonomous economy")
- /docs/walk ("Docs · Walk Avatar")
- /docs/start-here ("Docs · Start Here")
- /docs/make-your-agent ("Docs · Make Your First Agent")
- /docs/share-and-embed ("Docs · Share & Embed")
- /docs/sketchfab ("Docs · Sketchfab Showcase")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-08.md
