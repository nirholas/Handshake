# Docs audit batch 13: /docs/mcp-intel through /docs/authentication
...
3. Probe production for each path:
       ...
       for p in /docs/mcp-intel /docs/mcp-vanity /docs/mcp-naming /docs/mcp-marketplace /docs/skills /docs/widgets /docs/api-reference /docs/authentication; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/mcp-intel ("Docs · Intel MCP")
- /docs/mcp-vanity ("Docs · Vanity MCP")
- /docs/mcp-naming ("Docs · Naming MCP")
- /docs/mcp-marketplace ("Docs · Marketplace MCP")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-13.md
