# Service audit: services/pump-graduations
...
1. Read services/pump-graduations/README.md and its run configuration.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/service-pump-graduations.md
