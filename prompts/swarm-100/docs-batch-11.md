# Docs audit batch 11: /docs/economy-health-dashboard through /docs/sas-attestations
...
3. Probe production for each path:
       ...
       for p in /docs/economy-health-dashboard /docs/monitor /docs/money-flow-map /docs/money-feed /docs/reputation /docs/validation /docs/solana-reputation /docs/sas-attestations; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/economy-health-dashboard ("Docs · Economy Health Dashboard")
- /docs/monitor ("Docs · Agent Monitor")
- /docs/money-flow-map ("Docs · Money Flow Map")
- /docs/money-feed ("Docs · Money Feed")
- /docs/reputation ("Docs · Reputation System")
- /docs/validation ("Docs · Validation Attestations")
- /docs/solana-reputation ("Docs · Agent Reputation on Solana")
- /docs/sas-attestations ("Docs · SAS Credentialed Attestations")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-11.md
