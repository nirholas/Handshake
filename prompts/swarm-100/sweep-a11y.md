# Sweep: Accessibility suite green and extended
...
Run the existing a11y Playwright suite and fix every violation it finds. Then extend the spec to cover ten more high-traffic routes from data/pages.json (main and build sections first) and fix what the new coverage finds. Real fixes in markup and styles, never assertion downgrades.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sweep-a11y.md
