# Docs audit batch 29: /docs/examples through /docs/js-api
...
3. Probe production for each path:
       ...
       for p in /docs/examples /docs/forge-background-generation /docs/forge-off /docs/how-it-works /docs/i18n /docs/introduction /docs/irl /docs/js-api; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/examples ("Docs · Examples gallery")
- /docs/forge-background-generation ("Docs · Background generation and completion notifications")
- /docs/forge-off ("Docs · Forge-Off, community voting on the forge")
- /docs/how-it-works ("Docs · How three.ws works")
- /docs/i18n ("Docs · Internationalization")
- /docs/introduction ("Docs · Introduction and overview")
- /docs/irl ("Docs · IRL, agents in the real world")
- /docs/js-api ("Docs · JavaScript API reference")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-29.md
