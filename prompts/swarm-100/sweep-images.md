...
Run the image check and fix every finding: missing files, broken references, oversized assets that have a documented budget. Optimize with the tooling already in the repo; never delete a referenced asset without fixing the referent.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sweep-images.md
