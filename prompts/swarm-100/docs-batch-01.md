# Docs audit batch 01: /docs through /docs/coin-wars
...
3. Probe production for each path:
       ...
       for p in /docs /docs/ibm-community /docs/event-souvenirs /docs/play-live-events /docs/play-hardening /docs/play-forge-in-world /docs/swarms /docs/coin-wars; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done
...
- /docs ("Docs")
- /docs/ibm-community ("Docs · IBM Community post catalog")
- /docs/event-souvenirs ("Docs · Event souvenirs: the wearable you keep")
- /docs/play-live-events ("Docs · Live events in the /play world")
- /docs/play-hardening ("Docs · How /play stays safe, honest, and light")
- /docs/play-forge-in-world ("Docs · Forge items into a /play world from a prompt")
- /docs/swarms ("Docs · Trading swarms")
- /docs/coin-wars ("Docs · Coin Wars")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-01.md
