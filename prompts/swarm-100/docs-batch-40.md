# Docs audit batch 40: /tutorials/build-a-site-concierge through /tutorials/pay-for-x402-service
...
3. Probe production for each path:
       ...
       for p in /tutorials/build-a-site-concierge /tutorials/trigger-from-page-events /tutorials/upload-custom-glb /tutorials/connect-ai-brain /tutorials/create-and-edit-memory /tutorials/place-agent-irl /tutorials/voice-and-lipsync /tutorials/pay-for-x402-service; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /tutorials/build-a-site-concierge ("Tutorial · Build a site concierge from the building blocks")
- /tutorials/trigger-from-page-events ("Tutorial · Trigger the agent from page events")
- /tutorials/upload-custom-glb ("Tutorial · Upload a custom GLB avatar")
- /tutorials/connect-ai-brain ("Tutorial · Connect Anthropic or OpenAI as the brain")
- /tutorials/create-and-edit-memory ("Tutorial · Create, enhance & edit agent memory")
- /tutorials/place-agent-irl ("Tutorial · Place your agent in the real world (IRL)")
- /tutorials/voice-and-lipsync ("Tutorial · Give your agent a voice with lipsync")
- /tutorials/pay-for-x402-service ("Tutorial · Discover and pay for an x402 service")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-40.md
