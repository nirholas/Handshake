# API audit: api/v1 batch 01 (10 files)
...
- api/v1/_catalog.js
- api/v1/_providers.js
- api/v1/agents/[caip].js
- api/v1/ai/_text-to-3d-lane.js
- api/v1/ai/asr.js
- api/v1/ai/image.js
- api/v1/ai/text-to-3d.js
- api/v1/ai/tts.js
- api/v1/evm/swap-quote.js
- api/v1/gas.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-v1-01.md
