...
1. Read mcp-server/README.md and mcp-server/package.json (or the equivalent manifest).
2. Find every consumer: grep the repo for imports of this module and check
   STRUCTURE.md for the surfaces it powers.

## Task: bring mcp-server/ to verified-shippable
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sdk-mcp-server.md
