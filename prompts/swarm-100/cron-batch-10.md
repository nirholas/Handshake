# Cron audit batch 10: /api/cron/unstoppable-tick and 7 more
...
2. Scheduler truth (crons run on Cloud Scheduler, never in-process):
       ...
       gcloud scheduler jobs list --project aerial-vehicle-466722-p5 --location us-central1 | grep -E 'unstoppable-tick|forge-seed-cron|sketchfab-showcase|avatar-thumbnail-render|avatar-thumbnail-backfill|forge-thumbnail-backfill|agent-avatar-backfill|coin-intel-observe'
...
- /api/cron/unstoppable-tick
- /api/cron/forge-seed-cron
- /api/cron/sketchfab-showcase
- /api/cron/avatar-thumbnail-render
- /api/cron/avatar-thumbnail-backfill
- /api/cron/forge-thumbnail-backfill
- /api/cron/agent-avatar-backfill
- /api/cron/coin-intel-observe
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/cron-batch-10.md
