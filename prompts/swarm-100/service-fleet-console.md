# Service audit: services/fleet-console
...
1. Read services/fleet-console/README.md and its run configuration.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/service-fleet-console.md
