# Docs audit batch 02: /docs/in-game-economy through /crypto
...
3. Probe production for each path:
       ...
       for p in /docs/in-game-economy /docs/exit-lab /docs/crews /docs/economy-solver /docs/overlay-audit /docs/trading-hub /docs/world /crypto; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/in-game-economy ("Docs · The in-game economy")
- /docs/exit-lab ("Docs · Exit Lab")
- /docs/crews ("Docs · Crews")
- /docs/economy-solver ("Docs · The solved economy")
- /docs/overlay-audit ("Docs · Overlay audit")
- /docs/trading-hub ("Docs · The trading hub")
- /docs/world ("Docs World (immersive 3D docs)")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-02.md
