# API audit: api/agents batch 01 (10 files)
...
- api/agents/8004/agent.js
- api/agents/8004/search.js
- api/agents/[id].js
- api/agents/[id]/bundles.js
- api/agents/[id]/economy.js
- api/agents/[id]/memory-seed-x.js
- api/agents/[id]/pricing-rules.js
- api/agents/[id]/skill-access.js
- api/agents/[id]/skill-prices.js
- api/agents/[id]/skills-pricing.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-agents-01.md
