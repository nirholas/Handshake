# API audit: api/agents batch 07 (10 files)
...
- api/agents/pricing.js
- api/agents/public.js
- api/agents/pumpfun.js
- api/agents/pumpfun/[action].js
- api/agents/recovery-inbox.js
- api/agents/recovery.js
- api/agents/register/[action].js
- api/agents/reputation-batch.js
- api/agents/sas/[action].js
- api/agents/showrunner.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-agents-07.md
