# Docs audit batch 26: /docs/3d-api through /docs/agents-vs-avatars
...
3. Probe production for each path:
       ...
       for p in /docs/3d-api /docs/DESIGN-TOKENS /docs/agent-manifest /docs/agent-screen-control /docs/agent-shell /docs/agent-skills /docs/agent-wallets /docs/agents-vs-avatars; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/3d-api ("Docs · The three.ws 3D API")
- /docs/DESIGN-TOKENS ("Docs · Design tokens")
- /docs/agent-manifest ("Docs · Agent manifest reference")
- /docs/agent-screen-control ("Docs · Take the wheel: drive your agent's computer")
- /docs/agent-shell ("Docs · The agent shell")
- /docs/agent-skills ("Docs · The three.ws Agent Skills pack")
- /docs/agent-wallets ("Docs · Agent wallets")
- /docs/agents-vs-avatars ("Docs · Agents vs. avatars")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-26.md
