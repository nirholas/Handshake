# Cron audit batch 11: /api/cron/launcher-tick and 7 more
...
2. Scheduler truth (crons run on Cloud Scheduler, never in-process):
       ...
       gcloud scheduler jobs list --project aerial-vehicle-466722-p5 --location us-central1 | grep -E 'launcher-tick|reflect-sweep|oracle-digest|cosmetic-splits-sweep|launcher-claimer|solana-agents-crawl|treasury-topup|economy-rebalance'
...
- /api/cron/launcher-tick
- /api/cron/reflect-sweep
- /api/cron/oracle-digest
- /api/cron/cosmetic-splits-sweep
- /api/cron/launcher-claimer
- /api/cron/solana-agents-crawl
- /api/cron/treasury-topup
- /api/cron/economy-rebalance
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/cron-batch-11.md
