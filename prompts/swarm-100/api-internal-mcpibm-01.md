# API audit: api/_mcpibm batch 01 (5 files)
...
- api/_mcpibm/catalog.js
- api/_mcpibm/discovery.js
- api/_mcpibm/dispatch.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-internal-mcpibm-01.md
