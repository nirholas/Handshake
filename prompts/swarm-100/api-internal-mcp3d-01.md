# API audit: api/_mcp3d batch 01 (10 files)
...
- api/_mcp3d/dispatch.js
- api/_mcp3d/pricing.js
- api/_mcp3d/text-to-image.js
- api/_mcp3d/tools/ar.js
- api/_mcp3d/tools/persona-identity.js
- api/_mcp3d/tools/provenance.js
- api/_mcp3d/tools/spatial.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-internal-mcp3d-01.md
