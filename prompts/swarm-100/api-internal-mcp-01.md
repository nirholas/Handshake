# API audit: api/_mcp batch 01 (10 files)
...
- api/_mcp/auth.js
- api/_mcp/catalog.js
- api/_mcp/dispatch.js
- api/_mcp/embed-policy.js
- api/_mcp/origin.js
- api/_mcp/payments.js
- api/_mcp/render.js
- api/_mcp/tools/agents.js
- api/_mcp/tools/animations.js
- api/_mcp/tools/avatars.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-internal-mcp-01.md
