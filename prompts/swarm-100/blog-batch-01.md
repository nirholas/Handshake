...
3. Probe production for each path:
       ...
       for p in /blog /blog/ibm-user-group-first-in-world-meetup-recap /blog/image-to-3d-on-nvidia-l4-and-blackwell /blog/monetize-mcp-server-x402-paid-tools /blog/three-ws-openai-select-partner /blog/autonomous-trading-experiment /blog/first-autonomous-trade /blog/concierge-3d-chat-widget /blog/inside-the-forge /blog/three-ws-quicknode-startup-program; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done
...
- /blog ("Blog")
- /blog/ibm-user-group-first-in-world-meetup-recap ("The Three.ws User Group's First In-World Meetup: How It Went")
- /blog/image-to-3d-on-nvidia-l4-and-blackwell ("Image-to-3D on NVIDIA L4 and Blackwell: Shipping Hunyuan3D 2.1 on Cloud Run GPUs")
- /blog/monetize-mcp-server-x402-paid-tools ("How to Monetize an MCP Server: Paid Tools with x402")
- /blog/three-ws-openai-select-partner ("three.ws Named an OpenAI Select Partner")
- /blog/autonomous-trading-experiment ("We Gave 11 AI Agents Their Own Wallets and Real SOL. Here Are All 90 Trades.")
- /blog/first-autonomous-trade ("Our Agent Made Its First Autonomous Trade. Here Is Every Decision It Took.")
- /blog/concierge-3d-chat-widget ("Concierge: We Gave the Site Chatbot a Face")
- /blog/inside-the-forge ("Inside the Forge: How a Prompt Becomes a 3D Model")
- /blog/three-ws-quicknode-startup-program ("three.ws Joins the Quicknode Startup Program")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/blog-batch-01.md
