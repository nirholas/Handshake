# API audit: api/agents batch 05 (10 files)
...
- api/agents/balances.js
- api/agents/by-address/[addr].js
- api/agents/by-wallet.js
- api/agents/capabilities.js
- api/agents/check-name.js
- api/agents/copilot.js
- api/agents/economy.js
- api/agents/endpoint-shopper-run.js
- api/agents/ens/[name].js
- api/agents/eth-vanity.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-agents-05.md
