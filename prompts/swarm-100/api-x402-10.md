# API audit: api/x402 batch 10 (6 files)
...
- api/x402/vanity-verifiable.js
- api/x402/vanity.js
- api/x402/verify-receipt.js
- api/x402/wallet-connect.js
- api/x402/yield-scan.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-x402-10.md
