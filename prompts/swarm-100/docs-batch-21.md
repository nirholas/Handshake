# Docs audit batch 21: /cookbook/mcp-3d-tool through /docs/kol-tracker
...
3. Probe production for each path:
       ...
       for p in /cookbook/mcp-3d-tool /cookbook/asset-quality-gate /docs/payment-sessions /docs/developer-platform /docs/media-api /docs/forged /docs/generation-watch /docs/kol-tracker; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /cookbook/mcp-3d-tool ("Recipe: give your AI assistant a 3D tool")
- /cookbook/asset-quality-gate ("Recipe: gate 3D assets in CI")
- /docs/payment-sessions ("Docs: Payment Sessions")
- /docs/developer-platform ("Docs: Developer Platform")
- /docs/media-api ("Docs: three.ws Media & Render API")
- /docs/forged ("Docs: The Agent-Forged Gallery (/forged)")
- /docs/generation-watch ("Docs: Generation Watch (/watch)")
- /docs/kol-tracker ("Docs: KOL Tracker")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-21.md
