# Docs audit batch 23: /docs/creator-portfolio through /docs/agent-economy-volume
...
3. Probe production for each path:
       ...
       for p in /docs/creator-portfolio /docs/agent-wallet-api /docs/vaults /docs/user-wallet /docs/copy-trading /docs/deployments /docs/ca2x402 /docs/agent-economy-volume; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/creator-portfolio ("Docs: Creator portfolio")
- /docs/agent-wallet-api ("Docs: Agent wallet control API")
- /docs/vaults ("Docs: USDC agent vaults")
- /docs/user-wallet ("Docs: Your master wallet")
- /docs/copy-trading ("Docs: Copy Trading")
- /docs/deployments ("Docs: On-chain Deployments")
- /docs/ca2x402 ("Docs: CA to x402")
- /docs/agent-economy-volume ("Docs: Agent Economy Volume")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-23.md
