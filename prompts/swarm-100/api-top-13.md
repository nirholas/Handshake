# API audit: api/*.js batch 13 (10 files)
...
- api/pulse.js
- api/pump-bounties.js
- api/pump-fun-mcp.js
- api/quality-bench.js
- api/remix-feed.js
- api/scene-capture.js
- api/scene-glb-upload.js
- api/scene-upload.js
- api/search.js
- api/sentiment.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-top-13.md
