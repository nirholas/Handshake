# Docs audit batch 10: /docs/premium through /docs/circulation-engine
...
3. Probe production for each path:
       ...
       for p in /docs/premium /docs/x402-endpoints /docs/x402-revenue /docs/pump-launcher /docs/x402-dev-tools /docs/x402-buyer /docs/autonomous-x402 /docs/circulation-engine; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/premium ("Premium Pass: Monthly Data API Access")
- /docs/x402-endpoints ("Docs · x402 Paid Endpoints")
- /docs/x402-revenue ("Docs · x402 Revenue & Receipts")
- /docs/pump-launcher ("Docs · Pump Launcher")
- /docs/x402-dev-tools ("Docs · x402 Developer Tools")
- /docs/x402-buyer ("Docs · x402 Buyer Client")
- /docs/autonomous-x402 ("Docs · Autonomous x402 Loop")
- /docs/circulation-engine ("Docs · Circulation Engine")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-10.md
