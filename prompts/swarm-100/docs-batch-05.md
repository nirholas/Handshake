# Docs audit batch 05: /docs/mocap-studio through /docs/genesis
...
3. Probe production for each path:
       ...
       for p in /docs/mocap-studio /docs/selfie-to-avatar /docs/voice-lab /docs/lipsync /docs/talking-avatar-video /docs/galaxy /docs/ar-studio /docs/genesis; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/mocap-studio ("Docs · Mocap Studio")
- /docs/selfie-to-avatar ("Docs · Selfie to Avatar")
- /docs/voice-lab ("Docs · Voice Lab")
- /docs/lipsync ("Docs · Lipsync")
- /docs/talking-avatar-video ("Docs · Talking Avatar Video")
- /docs/galaxy ("Docs · Agent Galaxy")
- /docs/ar-studio ("Docs · AR Studio")
- /docs/genesis ("Docs · Instant Agent Genesis")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-05.md
