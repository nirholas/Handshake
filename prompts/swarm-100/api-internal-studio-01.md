# API audit: api/_studio batch 01 (3 files)
...
- api/_studio/catalog.js
- api/_studio/dispatch.js
- api/_studio/tools.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-internal-studio-01.md
