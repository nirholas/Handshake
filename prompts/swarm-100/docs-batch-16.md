# Docs audit batch 16: /tutorials/nvidia-nim-self-host through /tutorials/shopify-store-guide-advanced
...
3. Probe production for each path:
       ...
       for p in /tutorials/nvidia-nim-self-host /tutorials/first-prompt-to-3d /tutorials/agent-reputation /tutorials/solana-agent-reputation /tour-builder /tutorials/shopify-shopping-assistant /tutorials/shopify-store-guide /tutorials/shopify-store-guide-advanced; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /tutorials/nvidia-nim-self-host ("Tutorial · Run Microsoft TRELLIS on Your Own NVIDIA NIM")
- /tutorials/first-prompt-to-3d ("Tutorial · Your First Prompt to 3D in ChatGPT")
- /tutorials/agent-reputation ("Tutorial · Read an agent's reputation")
- /tutorials/solana-agent-reputation ("Tutorial · Read a Solana agent's reputation")
- /tour-builder ("Tour Builder: design a 3D store guide, no code")
- /tutorials/shopify-shopping-assistant ("Tutorial · 3D AI Shopping Assistant for Shopify")
- /tutorials/shopify-store-guide ("Tutorial · 3D Store Guide for Shopify (No Code)")
- /tutorials/shopify-store-guide-advanced ("Tutorial · Customize Your Shopify 3D Store Guide")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-16.md
