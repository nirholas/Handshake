# Docs audit batch 30: /docs/layers through /docs/multi-agent
...
3. Probe production for each path:
       ...
       for p in /docs/layers /docs/marketplace /docs/mcp-3d-studio /docs/mcp-tools /docs/memory /docs/mint-mark /docs/motion-swap /docs/multi-agent; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/layers ("Docs · The four layers")
- /docs/marketplace ("Docs · Marketplace")
- /docs/mcp-3d-studio ("Docs · 3D Studio MCP server")
- /docs/mcp-tools ("Docs · MCP tools catalog")
- /docs/memory ("Docs · Agent memory")
- /docs/mint-mark ("Docs · The three.ws mint mark")
- /docs/motion-swap ("Docs · Motion Swap")
- /docs/multi-agent ("Docs · Multi-agent scenes")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-30.md
