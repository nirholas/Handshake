...
Run eslint over the repo with the repo config. Fix every error properly; disable-comments are a last resort and each one needs a one-line justification in the report.
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sweep-lint.md
