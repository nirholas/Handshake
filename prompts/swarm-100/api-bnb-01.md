# API audit: api/bnb batch 01 (6 files)
...
- api/bnb/babt-check.js
- api/bnb/block-time.js
- api/bnb/latency.js
- api/bnb/register-agent.js
- api/bnb/vault-upload.js
- api/bnb/world-config.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-bnb-01.md
