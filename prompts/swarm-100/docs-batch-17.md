# Docs audit batch 17: /status through /docs/trader-card
...
3. Probe production for each path:
       ...
       for p in /status /glossary /support /events/build-3d-agents-live /docs/trading-surfaces /docs/trading-arenas /docs/custody /docs/trader-card; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done
...
- /glossary ("Glossary")
- /support ("Support")
- /events/build-3d-agents-live ("Building 3D AI Agents Live")
- /docs/trading-surfaces ("Docs · The Trading Surfaces")
- /docs/trading-arenas ("Docs · Competitive & Pooled Trading")
- /docs/custody ("Docs · Custody You Can Verify")
- /docs/trader-card ("Docs · Claim Your Wallet & Trader Card")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-17.md
