# Docs audit batch 34: /docs/hold-to-access through /docs/ibm
...
3. Probe production for each path:
       ...
       for p in /docs/hold-to-access /docs/plan-checkout /docs/market-data-api /docs/oracle /docs/x402-distribution /docs/x402-ring-economy /docs/three-microbuy /docs/ibm; do printf '%s ' "$p"; curl -so /dev/null -w '%{http_code}\n' "https://three.ws$p"; done

## Task: audit this batch of docs pages, then fix everything found

Pages in this batch:

- /docs/hold-to-access ("Docs · Hold-to-access")
- /docs/plan-checkout ("Docs · Paid plans")
- /docs/market-data-api ("Docs · Market Data API")
- /docs/oracle ("Docs · Oracle, the conviction engine")
- /docs/x402-distribution ("Docs · x402 distribution")
- /docs/x402-ring-economy ("Docs · The closed-loop x402 ring economy")
- /docs/three-microbuy ("Docs · The $THREE micro-buy loop")
- /docs/ibm ("Docs · IBM watsonx and Granite")
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/docs-batch-34.md
