# Cron audit batch 02: /api/cron/sniper-optimize and 7 more
...
2. Scheduler truth (crons run on Cloud Scheduler, never in-process):
       ...
       gcloud scheduler jobs list --project aerial-vehicle-466722-p5 --location us-central1 | grep -E 'sniper-optimize|sniper-evolve|sniper-loops-health|oracle-realized-labels|oracle-calibrate|dead-man-switch|gcp-burn-report|auto-rig-sweep'
...
- /api/cron/sniper-optimize
- /api/cron/sniper-evolve
- /api/cron/sniper-loops-health
- /api/cron/oracle-realized-labels
- /api/cron/oracle-calibrate
- /api/cron/dead-man-switch
- /api/cron/gcp-burn-report
- /api/cron/auto-rig-sweep
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/cron-batch-02.md
