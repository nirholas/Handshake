...
1. Read mcp-bridge/README.md and mcp-bridge/package.json (or the equivalent manifest).
2. Find every consumer: grep the repo for imports of this module and check
   STRUCTURE.md for the surfaces it powers.

## Task: bring mcp-bridge/ to verified-shippable
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/sdk-mcp-bridge.md
