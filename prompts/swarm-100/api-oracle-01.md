# API audit: api/oracle batch 01 (10 files)
...
- api/oracle/action-stream.js
- api/oracle/activity.js
- api/oracle/agent-stats.js
- api/oracle/backtest.js
- api/oracle/batch.js
- api/oracle/calibration.js
- api/oracle/categories.js
- api/oracle/coin.js
- api/oracle/feed.js
- api/oracle/follow.js
...
3. Delete this prompt file in that same commit:
       ...
       git rm prompts/swarm-100/api-oracle-01.md
