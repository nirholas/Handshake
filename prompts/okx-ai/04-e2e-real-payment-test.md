...
`/workspaces/three.ws`, or say "execute `prompts/okx-ai/04-e2e-real-payment-test.md`".
Read `prompts/okx-ai/00-CONTEXT.md`, `prompts/okx-ai/RUNBOOK.md`, `specs/okx-agent-payments.md`
and `CLAUDE.md` first. Append your outcome to `prompts/okx-ai/PROGRESS.md` at the end.
...
- [ ] `prompts/okx-ai/PROGRESS.md` appended: case-by-case table, remaining risks, and an
