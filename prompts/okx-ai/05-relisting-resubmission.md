...
`/workspaces/three.ws`, or say "execute `prompts/okx-ai/05-relisting-resubmission.md`".
...
OKX-04 must have recorded an explicit GO in `PROGRESS.md`. If it did not, run the parts of
...
- `PROGRESS.md`: the submitted catalog verbatim, CLI outputs, timestamp, approval status after
