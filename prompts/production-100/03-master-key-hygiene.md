...
`/workspaces/three.ws`, or say "execute `prompts/production-100/03-master-key-hygiene.md`".
...
4. **Document and hand the rotation to the owner.** Extend `docs/ops/wallet-key-migration.md`
   ...
   [OWNER-ACTIONS.md](OWNER-ACTIONS.md): rotate-or-accept decision, since the old value was
...
- [ ] Rotation row in [OWNER-ACTIONS.md](OWNER-ACTIONS.md); outcome in
      [PROGRESS.md](PROGRESS.md); this file deleted.
