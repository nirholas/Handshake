...
`/workspaces/three.ws`, or say "execute `prompts/production-100/02-stranded-wallet-reclaim.md`".
Read [00-INDEX.md](00-INDEX.md) and `CLAUDE.md` first.

## Binding operating clause

1. Finish 100%. Never end with a question or an unexecuted plan. When the definition of done
   is verified, delete this file and log in [PROGRESS.md](PROGRESS.md); any remainder gets a
...
4. **Write the owner decision brief**: `docs/ops/stranded-wallets.md`. It must contain the
   ...
   [OWNER-ACTIONS.md](OWNER-ACTIONS.md) pointing at the brief.
...
- [ ] One row in [OWNER-ACTIONS.md](OWNER-ACTIONS.md); outcome logged in
      [PROGRESS.md](PROGRESS.md); this file deleted (the owner decision itself stays open in
...
| Tempted to just fund the master instead | That is [OWNER-ACTIONS.md](OWNER-ACTIONS.md) capital, a different lever. This order is about honesty of the plan and the customer obligation. |
