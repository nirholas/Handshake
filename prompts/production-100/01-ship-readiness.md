...
`/workspaces/three.ws`, or say "execute `prompts/production-100/01-ship-readiness.md`".
...
[PROGRESS.md](PROGRESS.md), not deleting the file.
...
measurement in [PROGRESS.md](PROGRESS.md) and stop.
...
8. **Clean up.** `git worktree remove --force /workspaces/.deploy-wt`. Log the run in
   [PROGRESS.md](PROGRESS.md): prod SHA before and after, test summary, smoke result,
...
- [ ] Deploy worktree removed; run logged in [PROGRESS.md](PROGRESS.md).
