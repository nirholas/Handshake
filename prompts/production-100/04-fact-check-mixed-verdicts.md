...
`/workspaces/three.ws`, or say "execute `prompts/production-100/04-fact-check-mixed-verdicts.md`".
...
- [ ] Changelog entry written; outcome logged in [PROGRESS.md](PROGRESS.md); this file
