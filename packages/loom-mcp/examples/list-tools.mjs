// list-tools.mjs: print every tool @three-ws/loom-mcp advertises, with its input
// schema.
//
...
// { command: 'npx', args: ['-y', '@three-ws/loom-mcp'] } to exercise the
...
const client = new Client({ name: 'loom-mcp-list-tools-example', version: '1.0.0' });
