// list-tools.mjs: print every tool @three-ws/kol-mcp advertises, with its input
// schema.
//
...
// { command: 'npx', args: ['-y', '@three-ws/kol-mcp'] } to exercise the
...
const client = new Client({ name: 'kol-mcp-list-tools-example', version: '1.0.0' });
