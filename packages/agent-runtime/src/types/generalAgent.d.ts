import { ChatToolPayload, MessageToolCall } from './vendor.js';
import type { DeFiGuard } from '../core/toolRegistry.js';
...
export interface GeneralAgentConfig {
    ...
    /**
     * DeFi Guard configuration for risk/MEV analysis.
     * Overrides default thresholds for blocking, approval, and auto-execute limits.
     */
    domainGuard?: DeFiGuard;
    modelRuntimeConfig?: {
        /**
