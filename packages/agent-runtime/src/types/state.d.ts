import { ChatToolPayload, SecurityBlacklistConfig, UserInterventionConfig } from './vendor.js';
import type { Cost, CostLimit, Usage } from './usage.js';
import type { PortfolioPosition } from '../core/toolRegistry.js';
/**
...
export interface AgentState {
    ...
    /**
     * Portfolio positions for DeFi Guard risk analysis.
     * Injected by the server when available to enable risk-aware tool execution.
     */
