import { ChatToolPayload, ModelUsage, RuntimeInitialContext, RuntimeStepContext } from './vendor.js';
import type { FinishReason } from './event.js';
import { AgentState, ToolRegistry } from './state.js';
import type { Cost, CostCalculationContext, Usage } from './usage.js';
/**
...
export interface AgentRuntimeContext {
    ...
    phase: 'init' | 'user_input' | 'llm_result' | 'tool_result' | 'tools_batch_result' | 'task_result' | 'tasks_batch_result' | 'human_response' | 'human_approved_tool' | 'human_abort' | 'compression_result' | 'error';
...
export interface Agent {
     ...
     */
    calculateUsage?(operationType: 'llm' | 'tool' | 'human_interaction', operationResult: any, previousUsage: Usage): Usage;
 ...
 */
export type AgentInstruction = AgentInstructionCallLlm | AgentInstructionCallTool | AgentInstructionCallToolsBatch | AgentInstructionExecTask | AgentInstructionExecTasks | AgentInstructionExecClientTask | AgentInstructionExecClientTasks | AgentInstructionRequestHumanPrompt | AgentInstructionRequestHumanSelect | AgentInstructionRequestHumanApprove | AgentInstructionResolveAbortedTools | AgentInstructionCompressContext | AgentInstructionFinish;
