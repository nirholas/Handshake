import type { RuntimeStepContext, StepContextTodos } from '../types/vendor.js';
/**
 ...
 */
export declare const computeStepContext: ({ todos }: ComputeStepContextParams) => RuntimeStepContext;
