...
export class InterventionChecker {
     ...
     */
    static checkSecurityBlacklist(securityBlacklist = [], toolArgs = {}) {
     ...
     */
    static shouldIntervene(params) {
        const { config, toolArgs = {} } = params;
        // Use default blacklist if not provided
        const securityBlacklist = params.securityBlacklist !== undefined
     ...
     */
    static matchesSecurityRule(rule, toolArgs) {
     ...
     */
    static matchesRule(rule, toolArgs) {
     ...
     * @returns true if matches
     */
    static matchesArgument(matcher, value) {
     ...
     */
    static generateToolKey(identifier, apiName, argsHash) {
