 ...
 */
export const DEFAULT_SECURITY_BLACKLIST = [
    // ==================== File System Dangers ====================
    {
    ...
    },
    {
        ...
        match: {
            command: {
                pattern: '(cat|less|more|head|tail|vim|nano|vi|emacs|code).*(id_rsa|id_ed25519|id_ecdsa)(?!\\.pub).*',
                type: 'regex',
            },
        },
    },
    ...
    },
    {
        ...
        match: {
            command: {
                pattern: '(cat|less|more|head|tail|vim|nano|vi|emacs|code).*/\\.(bash_history|zsh_history|history).*',
                type: 'regex',
            },
        },
    },
    ...
    },
    {
        ...
        match: {
            command: {
                pattern: '(cat|less|more|head|tail|vim|nano|vi|emacs|code).*(Cookies|Login Data|Web Data).*',
                type: 'regex',
            },
        },
    },
