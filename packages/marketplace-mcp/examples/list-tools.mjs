// list-tools.mjs: print every tool @three-ws/marketplace-mcp advertises, with
// its input schema.
//
...
// { command: 'npx', args: ['-y', '@three-ws/marketplace-mcp'] } to exercise the
...
const client = new Client({ name: 'marketplace-mcp-list-tools-example', version: '1.0.0' });
