...
export const EXAMPLES = [
  ...
  { id: '07-live-price-webpage', title: 'Live price webpage', concept: 'Client-side JSON-RPC', difficulty: 'Beginner', proves: 'Read-only chain calls work from a static page with no backend, no build step, live on this gallery below.' },
  ...
  { id: '09-x402-paid-api-call', title: 'Pay for an API call', concept: 'x402 client', difficulty: 'Advanced', proves: 'USDG has no EIP-2612 permit, so the gasless rail is EIP-3009 transferWithAuthorization: the payer signs, the server broadcasts.' },
  { id: '10-x402-sell-your-api', title: 'Sell your API', concept: 'x402 server middleware', difficulty: 'Advanced', proves: 'Monetizing an endpoint is middleware, not architecture: one paywall() call, and a free route sits beside the paid one.' },
  { id: '11-mcp-agent-session', title: 'MCP agent session', concept: 'Model Context Protocol', difficulty: 'Advanced', proves: 'The SDK, an MCP server, and an agent host are three layers over one chain, and read-only tools never share a process with spending ones.' },
  ...
  { id: '13-launch-a-coin-testnet', title: 'Launch a coin (testnet)', concept: 'Launchpad direct rail', difficulty: 'Advanced', proves: 'A launch is a pipeline, not a transaction: screening, ticker uniqueness, artwork, caps and a live preflight all clear before any ETH moves.' },
  { id: '14-agent-paper-trader', title: 'Agent paper trader', concept: 'Strategy loop, simulated', difficulty: 'Intermediate', proves: 'A strategy loop is just getQuote on a timer, and real execution slots in later without a rewrite.' },
]
