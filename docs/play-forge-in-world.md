...
- [3D asset pipeline](3d-asset-pipeline.md): what the forge lanes are and how they differ
- [In-game economy](in-game-economy.md): the rest of what you can do inside a `/play` world
