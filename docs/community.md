...
New here? Start with [Your first contribution](first-contribution.md), a 15-minute path from clone to open PR. The full guide is [CONTRIBUTING.md](../CONTRIBUTING.md), and how we sort incoming work is documented in [Triage](triage.md).
