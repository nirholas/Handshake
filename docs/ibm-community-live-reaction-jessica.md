...
Friday](./ibm-community-blog-meetup-jessica.md), has the event details if you have not joined yet;
...
- Once posted, add it to the catalog in [ibm-community.md](./ibm-community.md) as a new discussion
