...
4. **Stance extraction**: `analyzeResults()` makes one LLM call over the top results, returning a 200-character excerpt and a stance (`supports`, `contradicts`, `neutral`) per source.
