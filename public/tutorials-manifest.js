...
(function () {
	const TUTORIALS = [
		...
		},
		{
			...
			blurb: 'Type one sentence into ChatGPT and get a real, textured 3D model back: spin it in the browser, download the GLB, and place it in your room through your phone camera. Free, no account, no API key.',
			builds: 'A generated 3D model, viewed and placed in AR, straight from ChatGPT',
			time: '10 min',
			previewModel: '/animations/robotexpressive.glb',
			ctaPrimary: { label: 'Open the 3D Studio', href: '/chatgpt' },
		},
		{
			slug: 'first-prompt-to-3d',
			tier: 'easy',
		...
		},
		{
			...
			time: '40 min',
			previewModel: '/animations/robotexpressive.glb',
			ctaPrimary: { label: 'Read the deep dive', href: '/blog/monetize-mcp-server-x402-paid-tools' },
		},
		{
		...
		},
		{
			...
			tier: 'advanced',
			title: 'Monetize an MCP server: charge per tool call',
			blurb: 'Build an MCP server that charges other people’s AI agents for its tools. One free tool, one paid tool, USDC on Solana, and the verify-work-settle ordering that means a failed call never takes money.',
			builds: 'A pay-per-call MCP server other agents can discover and buy from',
			time: '45 min',
			previewModel: '/animations/robotexpressive.glb',
