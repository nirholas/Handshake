	...
	const RECIPES = [
		{
			...
			posterAlt:
				'Six potted houseplants generated from one brief, after the vision critic rebuilt the three that failed',
			alsoOn: {
		...
		},
		{
			...
			poster: '/cookbook/posters/text-to-3d-cli.png',
			posterAlt:
				'A wooden treasure chest with iron bands, generated by this recipe and rendered with the platform renderer',
		},
		{
			...
			poster: '/cookbook/posters/parallel-asset-pack.png',
			posterAlt: 'A clay flower pot with a saucer, one of three models this recipe built in parallel',
		},
		{
			slug: 'mcp-3d-tool',
			...
			poster: '/cookbook/posters/mcp-3d-tool.png',
			posterAlt: 'A small friendly desk robot, generated through this MCP server itself',
		},
		{
			...
			poster: '/cookbook/posters/asset-quality-gate.png',
			posterAlt: 'A woven wicker basket at 147,617 triangles, the model that busted the default budget',
		},
	];
