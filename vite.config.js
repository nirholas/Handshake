	...
	build: {
		...
		rollupOptions: {
			...
			input: {
				...
				'admin-economy': resolve(__dirname, 'pages/admin/economy.html'),
		...
		},
		{
			...
			configureServer(server) {
				...
				const fileMap = {
					...
					'/admin/seeder/': resolve(root, 'pages/admin/seeder.html'),
					'/admin/economy': resolve(root, 'pages/admin/economy.html'),
					'/admin/economy/': resolve(root, 'pages/admin/economy.html'),
					'/admin/ring': resolve(root, 'pages/admin/ring.html'),
					'/admin/ring/': resolve(root, 'pages/admin/ring.html'),
					'/admin/ops': resolve(root, 'pages/admin/ops.html'),
					'/admin/ops/': resolve(root, 'pages/admin/ops.html'),
